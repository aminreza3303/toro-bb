...
صفحهٔ «خرید سازمانی» وضعیت زندهٔ snapshot، اندازهٔ کاتالوگ، شبکهٔ تأمین، ردیف‌های قیمت و تعداد agentها را مستقیماً از API نمایش می‌دهد. گراف اجرای `sku-guardian` تا `synthesis`، حالت fail-closed، محدودیت هم‌زمانی و تضمین‌های «بدون قیمت ساختگی»، «فقط SKU دقیق» و «منشأ قابل‌ممیزی» پیش از شروع فرایند قابل مشاهده‌اند؛ در نتیجه ادعای مهندسی محصول به trace و دادهٔ واقعی متصل است، نه به متن تبلیغاتی.

کاتالوگ نیز به‌جای فهرست بلند و مبهم، صفحه‌بندی ۱۲تایی، مرتب‌سازی، بازهٔ قابل‌مشاهده و فیلتر «فقط کالاهای قابل‌رتبه‌بندی» دارد. وضعیت هر کارت روشن می‌کند که کالا برای رتبه‌بندی آماده است یا فقط به‌عنوان سند منشأ نمایش داده می‌شود.
